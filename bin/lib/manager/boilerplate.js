const { FINAL_FORM, RECOIL } = require('../constants')
const {
  getPathToFile,
...
module.exports = async (formOption, stateManagementOption) => {
  ...
  if (stateManagementOption !== RECOIL)
    rimraf(getPathToFile('src', 'utils', 'storage.ts'))
